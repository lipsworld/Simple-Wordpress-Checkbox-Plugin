...
class Wp_cbv_Admin {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Wp_cbv_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Wp_cbv_Loader will then create the relationship
		 * between the defined hooks and the functions defined in this
		 * class.
		 */

		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/wp_cbv-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/wp_cbv-admin.js', array( 'jquery' ), $this->version, false );
	...
	*/
	...
	// Page to display plugin content

	public function display_plugin_setup_page() {
		include_once('partials/wp_cbv-admin-display.php');
	}

	public function option_update(){

		// Option group, option name, the callback function
	...
	public function validate($input){
		...
		// If checkbox if checked set 1, else 0
